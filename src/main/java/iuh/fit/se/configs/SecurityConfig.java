...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.cors(cors -> cors.configurationSource(request -> {
            ...
            corConfig.addAllowedOrigin("http://localhost:5174");
            corConfig.addAllowedOrigin("http://localhost:5175");
            corConfig.addAllowedOrigin("http://localhost:5176");
            corConfig.addAllowedOrigin("http://localhost:5177");
            corConfig.addAllowedOrigin("http://localhost:5178");
